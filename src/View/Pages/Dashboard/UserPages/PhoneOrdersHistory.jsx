  ...
  return (
    <>
      {newOrdersFirst.length > 0 ? (
        <section className="grid md:grid-cols-2 grid-cols-1 text-sm gap-4 p-2">
          {ordersLoading ? (
            ...
            newOrdersFirst.map((order) => (
              <div
                ...
                <div className="mt-2">
                  ...
                  <div className="flex gap-1">
                    <span>Phone:</span>
                    <span>{order?.userOrder?.cusPhone || "None"}</span>
                  </div>
                  {order?.userOrder?.cusReceiverPhone && (
                    <div className="flex gap-1">
                      <span>Receiver Phone:</span>
                      <span>
                        {order?.userOrder?.cusReceiverPhone || "None"}
                      </span>
                    </div>
                  )}
                  {order?.userOrder?.cusEmail && (
                    <div className="flex gap-1">
                      <span>Email:</span>
                      <span>{order?.userOrder?.cusEmail || "None"}</span>
                    </div>
                  )}
                ...
                <div className="mt-2 text-center  flex flex-col justify-end">
                  ...
                  <div className="border-t border-[#75934e] pt-1">
                    ORDER STATUS
                  </div>
                </div>
              </div>
        ...
        <div className="text-center md:text-xl text-base shadow-xl bg-rose-100 py-5 mt-28">
          <p>No order history available. Please please order something.</p>
        </div>
      )}
    </>
  );
