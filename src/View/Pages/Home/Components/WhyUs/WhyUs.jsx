  ...
  return (
    <section className="md:mt-32 my-20 my-container">
      ...
      <div className="mt-10 grid md:grid-cols-4 grid-cols-2 gap-3 gap-y-6">
        {/* high quality */}
        <div className="text-xl flex flex-col text-center justify-center gap-2  drop-shadow-2xl shadow-md items-center duration-500 p-3 py-4 font-mono border border-slate-400 hover:border-[#75934e] hover:text-[#75934e] text-slate-400">
        ...
        <div className="text-xl flex flex-col text-center justify-center drop-shadow-2xl shadow-md items-center duration-500  gap-2 p-3 py-4 font-mono border border-slate-400 hover:border-[#75934e] hover:text-[#75934e] text-slate-400">
